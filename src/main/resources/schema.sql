...
INSERT INTO t_contents (cid, title, slug, created, modified, content, author_id, type, status, tags, categories, hits, comments_num, allow_comment, allow_ping, allow_feed) VALUES (1, '待办', 'list', 1255791430, 1255791430, '### Hello World
...
- :lock: [之乎者也-博客](http://www.hitsf.me/)
- :lock: [之乎者也-论坛](http://www.hitsfweb.com/)
- :lock: [友情链接]()
...
INSERT INTO t_metas (mid, name, slug, type, description, sort, parent) VALUES (1, '默认', NULL, 'category', NULL, 0, 0);

-- 表：t_options
DROP TABLE IF EXISTS t_options;
CREATE TABLE t_options (name VARCHAR (100) PRIMARY KEY UNIQUE NOT NULL, value TEXT, description VARCHAR (255));
INSERT INTO t_options (name, value, description) VALUES ('site_title', '博客系统', '');
